...
#         if hasattr(content_obj, 'image') and content_obj.image:
#             return content_obj.image.url
#         elif hasattr(content_obj, 'task_image') and content_obj.task_image:
#             return content_obj.task_image.url
#
#         return None