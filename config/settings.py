...
SECRET_KEY = 'django-insecure-46bhd(k+o2552zeufwjt=9vwp4y38^d6!k4xj2r=bl_w*vnw%^'
...
CORS_ALLOWED_ORIGINS = [
    'https://grant.test-app.uz',
    'https://grand-production.up.railway.app',
    'http://localhost:8000',
    'https://grant-mvp-mnqd.vercel.app'
]
